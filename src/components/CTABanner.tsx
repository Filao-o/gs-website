  ...
  return (
    <section className="bg-[#1FA3BA] py-5">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-between gap-4">
        ...
        <a
          href="#reservation"
          className="flex items-center gap-2 bg-white text-[#1FA3BA] font-medium text-sm pl-5 pr-3 py-2.5 rounded-full hover:bg-white/90 transition-all shrink-0 group"
        >
          Réserver une course
